            ...
            <div id="content">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="h4 nav-link dropdown-toggle text-muted" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <span class="d-none d-lg-inline text-gray-600 small"><?php echo $row['nama_admin']; ?></span>                        
                    </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="h6 dropdown-item" data-bs-toggle="modal" data-bs-target="#logoutModal">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-secondary" aria-label="Close" type="button" data-bs-dismiss="modal">Cancel</button>
